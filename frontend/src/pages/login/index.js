...
document
  .getElementById("login-form-submit-button")
  .addEventListener("click", login);
document
  .getElementById("alert-banner-icon")
  .addEventListener("click", hideAlertBanner);

function hideAlertBanner() {
  document.getElementById("alert-banner-icon").parentElement.style.display =
    "none";
}
