...
<head>
  ...
  <script type=text/javascript src="static/2D.js"></script>
  <script type=text/javascript src="static/mousetrap-1.6.5.min.js"></script>
</head>
...
<script>
  $(document).ready(function() {
    ...
    oReq.open("GET", "<?php echo $API_URL; ?>/projects/");
    oReq.send();
  });
  </script>
